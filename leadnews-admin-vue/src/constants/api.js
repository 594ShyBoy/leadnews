export const API_USERAUTH = '/service_9001/login/in' // 用户认证

// 用户审核
export const API_AUTH_LIST = '/service_9002/api/v1/auth/list'
export const API_AUTH_PASS = '/service_9002/api/v1/auth/authPass'
export const API_AUTH_FAIL = '/service_9002/api/v1/auth/authFail'

// 频道管理
export const API_CHANNEL_LIST = '/service_9001/api/v1/channel/list'
export const API_CHANNEL_SAVE = '/service_9001/api/v1/channel/save'
export const API_CHANNEL_UPDATE = '/service_9001/api/v1/channel/update'
...
export const API_SENSITIVE_SAVE = '/service_9001/api/v1/sensitive/save'
export const API_SENSITIVE_UPDATE = '/service_9001/api/v1/sensitive/update'
export const API_SENSITIVE_DELETE = '/service_9001/api/v1/sensitive/del/'
